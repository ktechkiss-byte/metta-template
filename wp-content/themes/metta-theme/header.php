...
lối sống dưỡng sinh. | Chữa lành cơ thể - Metta đông y Spa" />
  ...
  <style id="global-styles-inline-css" type="text/css">
    :root {
      ...
      --wp--preset--color--primary: #603813;
      --wp--preset--color--secondary: #074404;
      --wp--preset--color--success: #627d47;
      --wp--preset--color--alert: #603813;
      ...
      --wp--preset--font-family--1-ftv-vip-medino: 1FTV VIP Medino;
    ...
    .has-1-ftv-vip-medino-font-family {
      font-family: var(--wp--preset--font-family--1-ftv-vip-medino) !important;
    }
  ...
  <script>
    ...
    })(window, document, "script", "dataLayer", "GTM-NHK37WQX");
  </script>
  <!-- End Google Tag Manager -->
  <meta name="facebook-domain-verification" content="dfcu2crap6d1q077e9qwdfycbsdoqb" />
  <noscript>
    <style>
      .lazyload[data-src] {
  ...
  <style type="text/css" id="wp-custom-css">
    ...
    *::-webkit-scrollbar-track {
    ...
    .home-why-image-box .box-image {
      border-radius: 227.062px 227.062px 0px 0px;
      border: 1px solid var(--vang-dat, #a87e09);
    }

    .home-why-image-box~.btn-cta {
      display: block;
      text-align: center;
      padding: 20px 20px;
    ...
    #wpforms-form-206 textarea {
      background: none;
      border: 1px solid var(--vang-dat, #a87e09) !important;
    }
    ...
    /* .about-cot-loi-section .section-bg-overlay {
        background: linear-gradient(
          180deg,
          #fffcf9 0%,
          rgba(255, 252, 249, 0.6) 51.44%,
          #fffcf9 100%
        );
      } */
    ...
    .banner-grid::before {
      ...
      background: linear-gradient(0deg,
          rgba(255, 252, 249, 0) 0%,
          /* Trong suốt ở đáy */
          rgba(255, 252, 249, 0.6) 60%,
          /* Màu mờ ở giữa */
          rgba(255, 252, 249, 0.9) 85%,
          /* Gần đầy */
          #fffcf9 100%
          /* Màu nền đầy ở trên cùng */
        );
      position: absolute;
      top: 0;
      width: 100%;
    ...
    .banner-grid::after {
      ...
      background: linear-gradient(0deg,
          ...
          #fffcf9 0%,
          /* Màu nền đầy ở trên cùng */
          rgba(255, 252, 249, 0.9) 15%,
          /* Gần đầy */
          rgba(255, 252, 249, 0.6) 40%,
          /* Màu mờ ở giữa */
    ...
    .home-big-banner-textbox>div {
      ...
      background: linear-gradient(180deg,
          #4d3400 20.54%,
          rgb(77 52 0 / 85%) 52.95%,
          rgb(77 52 0 / 58%) 76.68%,
          rgb(77 52 0 / 0%) 94.94%);
    }
    ...
    .header.transparent.has-transparent.has-sticky.sticky-jump .header-wrapper {
      ...
      border-bottom: 1px solid rgba(244, 157, 33, 0.4);
    }

    .bannergioithieu .video-button-wrapper a {
      border: 2px solid #fffcf9;
      background: linear-gradient(180deg, #603813 0%, #c67427 100%);
      height: 50px;
      width: 50px;
    }
