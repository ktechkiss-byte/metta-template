<?php
/* Template Name: page-tin-tuc */
get_header(); ?>

<main id="main">
  <div id="content" class="blog-wrapper blog-archive page-wrapper container" style="padding-top: 130px; padding-bottom: 80px; margin: 0 auto;">
    <div class="row align-center" style="margin: auto;">
      <div class="large-12 col">
        <header class="archive-header text-center" style="margin-bottom: 60px;">
            <h1 class="page-title" style="color: var(--primary-color); font-size: 3rem; font-weight: 800; text-transform: uppercase;">Tin Tức & Sự Kiện</h1>
        ...
        <div id="post-list" class="row" style="justify-content: center;">
           <?php
